...
import micdoodle8.mods.galacticraft.planets.kepler186f.tile.TileEntityHydrogenPipe;
...
//    private IIcon pipeIcon;
    ...
    public IIcon getIcon(IBlockAccess par1IBlockAccess, int x, int y, int z, int par5)
    {
        ...
        if (blockAt == Kepler186FBlocks.hydrogenPipe)
        {
    ...
    {
        this.pipeIcon = par1IconRegister.registerIcon(Kepler186FModule.TEXTURE_PREFIX + "pipe_hydrogen");
