...
public class BlockCreeperEgg extends BlockDragonEgg implements IShiftDescription, ISortableBlock
{
    ...
    {
        this.blockIcon = iconRegister.registerIcon(Kepler186FModule.TEXTURE_PREFIX + "creeperEgg");
    }*/
    ...
    public boolean canHarvestBlock(IBlockAccess world, BlockPos pos, EntityPlayer player)
    {
        ...
        return stack.getItem() == Kepler186FItems.deshPickSlime;
    }

    public float getPlayerRelativeBlockHardness(EntityPlayer playerIn, World worldIn, BlockPos pos)
    {
        ItemStack stack = playerIn.inventory.getCurrentItem();
        if (stack != null && stack.getItem() == Kepler186FItems.deshPickSlime)
        {
            return 0.2F;
        }
